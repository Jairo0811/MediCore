...
No se infiere que ambos hayan cursado una misma asignatura en ITLA; la coincidencia académica confirmada corresponde a **MediCore (ISO-605)** en UNAPEC.
...
| **1** | Identidad, autenticación, roles y permisos | ✅ Implementada |
| **2** | Pacientes | ✅ Implementada |
